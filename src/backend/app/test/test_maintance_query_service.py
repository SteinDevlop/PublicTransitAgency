...
from src.backend.app.api.routes.maintance_query_service import app as maintainance_query_router
...
def override_controller(monkeypatch):
    from src.backend.app.api.routes import maintance_query_service
