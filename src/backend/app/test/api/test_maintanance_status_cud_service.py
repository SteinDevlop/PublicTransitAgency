...
from backend.app.api.routes.maintainance_status_cud_service import router as status_router # Corregido el nombre de la importación
...
app_for_test.include_router(status_router) # Corregido el nombre de la variable
client = TestClient(app_for_test)

def test_create_status(test_db):
...
def test_update_status_existing(test_db):
...
def test_delete_status_existing(test_db):
