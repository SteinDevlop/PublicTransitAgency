...
# Route to consult and display the 'ConsultarPrecios' HTML page
@app.get('/consultar', response_class=HTMLResponse)
def consultar(request: Request):
    """
    Renders the 'ConsultarPrecios.html' template to show the price consultation page.
    """
    return templates.TemplateResponse("ConsultarPrecios.html", {"request": request})
...
# Route to view a specific precio by its ID and render the 'precio.html' template
