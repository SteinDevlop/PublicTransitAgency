...
def listar_estados(
    request: Request,
    current_user: dict = Security(get_current_user, scopes=["system", "mantenimiento", "supervisor"])
):
    """
    List all maintenance statuses. Requires authentication.
    """
...
def detalle_estado(
    ...
    """
    Get details of a specific maintenance status by ID. Requires authentication.
    """
