...
app.include_router(user_CUD_service.router)
app.include_router(type_movement_cud_service.router)
app.include_router(type_transport_cud_service.router)
app.include_router(rol_user_cud_service.router)
app.include_router(movement_cud_service.router)
app.include_router(maintainance_status_query_service.app)
app.include_router(incidence_cud_service.app)
app.include_router(price_cud_service.router)
...
app.include_router(movement_query_service.router)
...
app.include_router(user_query_service.router)
app.include_router(price_query_service.router)
app.include_router(type_movement_query_service.router)
app.include_router(type_transport_query_service.router)
app.include_router(rol_user_query_service.router)
app.include_router(pqr_query_service.router)
app.include_router(pqr_cud_service.router)
app.include_router(asistance_cud_service.router)
app.include_router(asistance_query_service.router)
app.include_router(behavior_cud_service.router)
app.include_router(behavior_query_service.router)
app.include_router(rutaparada_query_service.app)
app.include_router(rutaparada_cud_service.app)